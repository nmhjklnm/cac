> 这是从原上游式 README 迁出的完整归档，用于保留跨平台背景和命令参考。其中的 npm 安装/更新说明只适用于上游包，不适用于当前 `cac-win` fork；Windows 本地安装请以根目录 [README](../README.md) 为准。
...
<picture>
  ...
  <img alt="cac" src="images/logo-light.svg" width="200">
</picture>
